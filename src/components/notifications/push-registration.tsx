...
export function PushRegistration() {
  ...
  return <div className="mt-5"><button type="button" onClick={enable} className="rounded-lg border border-white/20 px-3 py-2 text-sm">Activar notificaciones</button>{message && <p role="status" className="mt-2 text-sm text-zinc-400">{message}</p>}</div>;
}
