...
export const confirmationStepSchema = z.object({ senderEmail: emailSchema, paymentMethod: z.enum(["cash", "transfer", "mercado_pago_manual"]), urgent: z.boolean(), termsAccepted: z.boolean().refine((value) => value, "Debés aceptar los términos") });
