...
const protectedRoles: Record<string, UserRole> = { "/account": "customer", "/solicitar": "customer", "/courier": "courier", "/admin": "admin" };
...
export const config = { matcher: ["/((?!_next/static|_next/image|favicon.ico|manifest.json|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*)"] };
